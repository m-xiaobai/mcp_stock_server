...
def create_mcp_server(
    ...
    @app.tool(
        ...
        description="Authoritative B1 stock screener:short trend > multi-trend, close > multi-trend, J < 20, amplitude < 7%.Returns only stocks that pass all B1 conditions.",
    )
